...
function Cotizacion() {
  return (
    <div className='w-full h-full bg-red-600 p-4 py-16'>
      <div className='w-full grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1  grid-rows-1 justify-around text-center items-center'>
        ...
        <div>
          <a href='http://wa.me/+50765844123' target='_blank' className='border border-gray-50 py-2 px-4 rounded-md hover:bg-gray-50 hover:text-gray-900 transition duration-500 text-2xl font-normal'>Cotizar</a>
        </div>
      </div>
    </div>
  )
